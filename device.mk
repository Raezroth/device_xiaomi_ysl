...
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/ubuntu/70-ysl.rules:system/halium/lib/udev/rules.d/70-android.rules \
    $(LOCAL_PATH)/ubuntu/70-ysl.rules:system/halium/usr/lib/lxc-android-config/70-android.rules \
    $(LOCAL_PATH)/ubuntu/70-ysl.rules:system/halium/etc/udev/rules.d/70-android.rules \
